...
@Tag(
        name = "Transactions",
        description = "Money transfers, transaction history, summaries and recent contacts"
)
@RestController
...
public class TransactionController {
    ...
    @Operation(
            ...
            description = "Returns authenticated user's transaction history."
    )
    @SecurityRequirement(name = "bearerAuth")
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Returns complete transaction information by transaction id."
    )
    @SecurityRequirement(name = "bearerAuth")
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Search transactions by status, type or transaction id."
    )
    @SecurityRequirement(name = "bearerAuth")
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Returns total sent, total received and transaction statistics."
    )
    @SecurityRequirement(name = "bearerAuth")
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Returns users recently involved in transfers."
    )
    @SecurityRequirement(name = "bearerAuth")
    @ApiResponses({
